...
""" agregamos la autentificacion de la cuenta """
...
from autentificacion import crear_token, verificar_token
...
def roles(usuario: str = Depends(verificar_token)):
...
def obtener_perfil(usuario: dict = Depends(verificar_token)):
    return {
        "mensaje": f"Bienvenido {usuario['usuario']}",
        "datos_extra": "Acceso concedido a contenido privado"
    }
